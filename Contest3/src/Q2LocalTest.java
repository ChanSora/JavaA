...
//            System.out.printf("%d %d %d %d %d\n", r1, c1, r2, c2, id);
        ...
        public static void click(int r, int c, Window[] wins, int[][] mat) {
            int windows_id = map.get(mat[r][c]);
            int r1 = wins[windows_id].r1();
            int c1 = wins[windows_id].c1();
            int r2 = wins[windows_id].r2();
            int c2 = wins[windows_id].c2();
            int id = wins[windows_id].id();
//            System.out.printf("%d %d %d %d %d\n", r1, c1, r2, c2, id);
            for (int j = r1; j <= r2; j++) {
                for (int l = c1; l <= c2; l++) {
                    mat[j][l] = id;
        ...
        public static void printScreen(int[][] mat) {
            for (int i = 0; i < mat.length; i++) {
                for (int j = 0; j < mat[i].length; j++) {
                    System.out.printf("%d%c", mat[i][j], j == mat[i].length - 1 ? '\n' : ' ');
                }
            }
        };
    }
